...
class GuestService:
    ...
    def save_uuid_and_nickname(self, uuid: str, nickname: str):
        """
        uuid와 닉네임을 저장합니다.
        """
...
class NicknameService:
    ...
    async def generate_and_cache_nickname(self):
        """
...
class GuestBookService:
    @staticmethod
    def save_guestbook_message(uuid: str, message: str):
        """
        방명록을 저장합니다.
        """
    ...
    def get_guestbook_messages() -> List[GuestBookResponse]:
        ...
        return [GuestBookResponse(**r) for r in results]